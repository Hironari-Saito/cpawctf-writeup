'''
this program is copyed from https://rextester.com/LQHCX48992 and modified to python3
'''
...
print('Do you want to test a password, or crack one? (SHA-1)')
answer = input('>')
if answer.lower() == 'crack':
								...
								while i8 <= charslen-1:
									while i9 <= charslen-1:
										while i10 <= charslen-1:
											...
											guess += c10
											loops += 1
											hashed = hashlib.sha1(guess.encode('utf-8')).hexdigest()
